...
class WebConfigContractTest(unittest.TestCase):
    ...
    def test_hardware_page_exposes_led_and_slot_visual_state(self) -> None:
        ...
        self.assertIn("hardware_best_led_action_for_control", self.web_config)
        self.assertIn("hardware_action_led_preview", self.web_config)
        self.assertIn("hardware_action_active", self.web_config)
        self.assertIn("hardware_action_slot_border_color", self.web_config)
        self.assertIn("slotDisplayInitialized[currentBank][act->slot]", self.web_config)
        self.assertIn("slotBorderColor[act->slot]", self.web_config)
        self.assertIn("hardware_action_slot_border_color(ledAction)", self.web_config)
        self.assertIn("hardware_action_slot_border_color(bestAction)", self.web_config)
        ...
        self.assertNotIn("hardware_led_preview_color", self.web_config)
        self.assertIn("if (pedalino::rgb_color_active(fallbackColor)) return hardware_css_color(fallbackColor);", self.web_config)
        self.assertIn("if (fallbackActive && pedalino::rgb_color_active(fallbackColor)) return true;", self.web_config)
        ...
        self.assertIn('F(",\\"borderColor\\":")', self.web_config)
        self.assertIn("hardwareLed", self.web_config)
